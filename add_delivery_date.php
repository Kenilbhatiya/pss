...
if ($column_exists && mysqli_num_rows($column_exists) == 0) {
    ...
    echo "<p>The delivery_date column already exists in the orders table or there was an error checking columns.</p>";
}

// Close connection
mysqli_close($conn);

// Redirect back to myaccount page after 3 seconds
echo "<p>Redirecting back to my account page in 3 seconds...</p>";
echo "<script>setTimeout(function(){ window.location.href = 'myaccount.php'; }, 3000);</script>";
?> 